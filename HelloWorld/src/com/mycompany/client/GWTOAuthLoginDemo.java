...
import com.mycompany.client.model.Credential;
import com.mycompany.client.model.SocialUser;
import com.mycompany.client.resources.MyResources;
import com.mycompany.client.resources.images.MyImages;
import com.mycompany.client.rpc.MyAsyncCallback;
import com.mycompany.client.rpc.OAuthLoginService;
import com.mycompany.client.ui.AppScreen;
import com.mycompany.client.ui.AppScreenLogin;
import com.mycompany.client.ui.LoginDialog;
import com.mycompany.client.ui.LoginScreen;
import com.mycompany.client.ui.MessageDialog;
import com.mycompany.client.ui.TopBar;
import com.mycompany.client.util.ClientUtils;
...
public class GWTOAuthLoginDemo implements EntryPoint
{
    ...
    public void showAboutMessage()
    {
        ...
        final String aboutMessage = 
            ...
            "<br><br>" +
            "Source will be made public when I get some time." +
            "<br>" +
            "--" +
            "<br>" +
